...
namespace SchoolEnterpriseManageSys.Utilities.CommomHelper
{
    ...
    public class PinyinHelper
    {
        ...
        private static System.Text.RegularExpressions.Regex regWord = new System.Text.RegularExpressions.Regex("[a-zA-Z]");
        private static System.Text.RegularExpressions.Regex regNum = new System.Text.RegularExpressions.Regex("[0-9]");

        #region static stor.
        static PinyinHelper()
        {
            _pinyinHash = new System.Collections.Hashtable();
