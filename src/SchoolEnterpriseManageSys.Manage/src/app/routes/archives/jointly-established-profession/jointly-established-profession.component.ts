...
@Component({
  selector: 'archives-jointly-established-profession',
  templateUrl: './jointly-established-profession.component.html',
  providers: [ProjectService],
})
export class ArchivesJointlyEstablishedProfessionComponent implements OnInit {
  constructor(
  ...
  input: any = { keyword: '', pageIndex: 1, pageSize: 10, type: 256 }; //
  ...
  edit(dep: any) {
    if (dep.id)
      // this.router.navigateByUrl('/archives/JointlyEstablishedProfession/edit/' + dep.id);
      this.router.navigate(['/archives/JointlyEstablishedProfession/edit', { "id": dep.id }]);
  }

  add() {
    this.router.navigateByUrl('/archives/JointlyEstablishedProfession/edit');
  }
