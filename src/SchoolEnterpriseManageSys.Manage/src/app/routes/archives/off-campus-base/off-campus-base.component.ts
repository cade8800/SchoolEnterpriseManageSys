...
@Component({
  selector: 'archives-off-campus-base',
  templateUrl: './off-campus-base.component.html',
  providers: [ProjectService],
})
export class ArchivesOffCampusBaseComponent implements OnInit {
  constructor(
  ...
  input: any = { keyword: '', pageIndex: 1, pageSize: 10, type: 2 }; //
  ...
  edit(dep: any) {
    if (dep.id)
      // this.router.navigateByUrl('/archives/OffCampusBase/edit/' + dep.id);
      this.router.navigate(['/archives/OffCampusBase/edit', { id: dep.id }]);
  }

  add() {
    this.router.navigateByUrl('/archives/OffCampusBase/edit');
  }
