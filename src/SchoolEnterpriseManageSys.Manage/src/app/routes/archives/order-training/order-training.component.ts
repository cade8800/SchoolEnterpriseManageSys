...
@Component({
  selector: 'archives-order-training',
  templateUrl: './order-training.component.html',
  providers: [ProjectService],
})
export class ArchivesOrderTrainingComponent implements OnInit {
  constructor(
  ...
  input: any = { keyword: '', pageIndex: 1, pageSize: 10, type: 16 }; //
  ...
  edit(dep: any) {
    if (dep.id)
      // this.router.navigateByUrl('/archives/OrderTraining/edit/' + dep.id);
      this.router.navigate(['/archives/OrderTraining/edit', { id: dep.id }]);
  }

  add() {
    this.router.navigateByUrl('/archives/OrderTraining/edit');
  }
